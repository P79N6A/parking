 ...
 */
@Component
public class AddParkingLotDtoValidatorImpl extends ValidatorHandler<AddParkingLotRequestDto> implements AddParkingLotRequestDtoValidator {
    ...
    @Override
    public boolean validate(ValidatorContext context, AddParkingLotRequestDto requestDto) {
        //租户
        ...
        if (parkingLotInfoEntity != null) {
            throw new ValidationException(ParkingLotConstant.PARKING_LOT_LOCAL_CODE_USED);
        }
