...
@ApiModel(value = "ParkingRecordQueryByIntoRecordNoRequestDto", description = "根据入车流水号修改泊位请求参数")
public class ParkingRecordQueryByIntoRecordNoRequestDto extends BaseDto {
