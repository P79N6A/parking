...
@ApiModel(value = "AppointOrderDetailViewResultDto", description = "预约订单详情视图")
public class AppointOrderDetailViewResultDto extends BaseDto {
