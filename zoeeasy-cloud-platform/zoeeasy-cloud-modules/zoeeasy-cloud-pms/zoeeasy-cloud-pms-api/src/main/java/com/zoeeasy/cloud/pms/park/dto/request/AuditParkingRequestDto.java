...
@ApiModel(value = "AuditParkingRequestDto", description = "审核停车场请求参数")
public class AuditParkingRequestDto extends SignedSessionRequestDto {
    ...
    @FluentValidate({AuditOpinionEnumValidator.class})
    @NotNull(message = ParkingConstant.AUDIT_OPINION_NOT_NULL)
    ...
    @FluentValidate({PutAwayStatusEnumValidator.class})
    ...
    @FluentValidate({AuditNotPassReasonEnumValidator.class})
