...
@ApiModel(value = "FloorUpdateRequestDto", description = "楼层修改请求参数")
public class FloorUpdateRequestDto extends SignedSessionRequestDto {
    ...
    @NotNull(message = GarageConstant.ID_NOT_NULL)
    private Long id;
