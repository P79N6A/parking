...
@ApiModel(value = "AddParkingInfoRequestDto", description = "停车场管理系统添加停车场请求参数")
public class AddParkingInfoRequestDto extends SignedRequestDto {
     ...
     * 开始营业时间,格式HH:mm
     */
    @ApiModelProperty("开始营业时间,格式HH:mm")
     ...
     * 客户端系统编号
     */
    @ApiModelProperty(value = "客户端系统编号", required = true)
    @NotBlank(message = ParkingConstant.CLOUD_CODE_NOT_EMPTY)
