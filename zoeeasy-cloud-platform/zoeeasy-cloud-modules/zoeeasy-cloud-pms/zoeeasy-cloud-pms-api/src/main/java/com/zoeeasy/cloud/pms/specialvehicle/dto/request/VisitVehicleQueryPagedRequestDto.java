...
@ApiModel(value = "VisitVehicleQueryPagedRequestDto", description = "访客车列表分页请求参数")
public class VisitVehicleQueryPagedRequestDto extends SignedSessionPagedRequestDto {
