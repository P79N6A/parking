...
@ApiModel(value = "ThirdPartyParkingUpdateRequestDto", description = "修改第三方停车场请求参数")
public class ThirdPartyParkingUpdateRequestDto extends SignedSessionEntityDto<Long> {
