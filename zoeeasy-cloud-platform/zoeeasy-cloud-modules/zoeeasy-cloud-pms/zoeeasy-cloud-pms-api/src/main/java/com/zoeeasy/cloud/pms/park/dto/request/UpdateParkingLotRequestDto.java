...
@ApiModel(value = "UpdateParkingLotRequestDto", description = "停车场管理系统修改泊位请求参数")
public class UpdateParkingLotRequestDto extends SignedRequestDto {
