...
@ApiModel(value = "ChargeRuleViewResultDto", description = "收费规则返回结果模型")
public class ChargeRuleViewResultDto extends EntityDto<Long> {
    ...
    private List<ChargeRuleTimeResultDto> partTimes;

    /**
     * 规则是否关联停车场
     */
    @ApiModelProperty("规则是否关联停车场")
