...
@ApiModel(value = "ParkingAppointOrderListGetRequestDto", description = "获取预约订单列表请求参数")
public class ParkingAppointOrderListGetRequestDto extends SignedSessionRequestDto {
