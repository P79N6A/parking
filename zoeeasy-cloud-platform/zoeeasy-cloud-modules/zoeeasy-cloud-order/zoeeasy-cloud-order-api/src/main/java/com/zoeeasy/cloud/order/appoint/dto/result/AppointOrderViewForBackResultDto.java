...
@ApiModel(value = "AppointOrderViewForBackResultDto", description = "预约订单详情视图")
public class AppointOrderViewForBackResultDto extends BaseDto {
