...
@ApiModel(value = "CompleteParkingPaymentRequestDto", description = "海康平台停车账单请求参数")
public class HikvisionPaymentCompleteRequestDto extends BaseDto implements Serializable {
     ...
     * 支付金额 单位： 分
     */
    @ApiModelProperty(value = "支付金额(位： 分)", required = true)
