...
@ApiModel(value = "WeiXinPayRecordQueryPageRequestDto", description = "分页获取微信支付记录")
public class WeiXinPayRecordQueryPageRequestDto extends SessionPagedRequestDto {
