 ...
 * @author: lhj
 */
@ApiModel(value = "FuShangHeartBeatPushRequestDto", description = "富尚推送心跳请求参数")
@Data
@EqualsAndHashCode(callSuper = false)
public class FuShangHeartBeatPushRequestDto extends BaseDto implements Serializable {
    ...
    private FuShangHeartBeatBodyRequestDto body;
}
