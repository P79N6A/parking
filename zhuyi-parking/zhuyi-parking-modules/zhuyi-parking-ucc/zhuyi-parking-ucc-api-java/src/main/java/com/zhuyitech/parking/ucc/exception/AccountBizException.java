package com.zhuyitech.parking.ucc.exception;
 ...
 * @date 2018-01-10
 */
public class AccountBizException extends BusinessException {
    ...
    public static final AccountBizException ACCOUNT_SUB_AMOUNT_INVALID = new AccountBizException(10010006, "减款金额无效");
    ...
    public AccountBizException newInstance(String msgFormat, Object... args) {
        return new AccountBizException(this.exeCode, msgFormat, args);
    }
}
