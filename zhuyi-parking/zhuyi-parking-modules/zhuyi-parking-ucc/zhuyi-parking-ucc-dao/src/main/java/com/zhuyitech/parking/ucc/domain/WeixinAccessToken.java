 ...
 * @author zwq
 */
@TableName("up_weixin_access_token")
@SuppressWarnings("serial")
public class WeixinAccessToken extends FullAuditedEntity<Long> implements Serializable {
     ...
     * 令牌有效期
     */
    @TableField(value = "tokenExpiredSeconds")
     ...
     * 刷新令牌有效期
     */
    @TableField(value = "refreshTokenExpiredSeconds")
