 ...
 * @author zwq
 */
@TableName("up_app_version")
public class AppVersion extends FullAuditedEntity<Long> {
     ...
     * 下架时间
     */
    @TableField(value = "withdrawTime")
    private Date withdrawTime;

    /**
     * 是否强制更新
     */
    @TableField(value = "forceUpdate")
