 ...
 * @author walkman
 */
@ApiModel(value = "CarBrandQueryPagedResultRequestDto", description = "车型列表分页请求参数表")
@Data
@EqualsAndHashCode(callSuper = false)
public class CarBrandQueryPagedResultRequestDto extends SessionPagedRequestDto {
